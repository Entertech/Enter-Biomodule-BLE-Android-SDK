 ...
 */
class MultipleRxBleManager constructor(context: Context) {
...
//    companion object {
//        @Volatile
//        private var instance: MultipleRxBleManager? = null
//
//        fun getInstance(context: Context): MultipleRxBleManager {
//            if (instance == null) {
//                synchronized(MultipleRxBleManager::class) {
//                    if (instance == null) {
//                        instance = MultipleRxBleManager(context.applicationContext)
//                    }
//                }
//            }
//
