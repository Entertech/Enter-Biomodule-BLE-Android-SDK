...
//    companion object {
//        @Volatile
//        var mBleDeviceManager: MultipleBiomoduleBleManager? = null
//
//        fun getInstance(context: Context): MultipleBiomoduleBleManager {
//            if (mBleDeviceManager == null) {
//                synchronized(MultipleBiomoduleBleManager::class.java) {
//                    if (mBleDeviceManager == null) {
//                        mBleDeviceManager = MultipleBiomoduleBleManager(context)
//                    }
//                }
//            }
...
//    }
    ...
    private fun castBattery(
        byte: Byte, success: (NapBattery) -> Unit, failure: ((String) -> Unit)? = null
    ) {
