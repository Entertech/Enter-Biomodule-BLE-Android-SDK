...
import cn.entertech.ble.utils.hasLocationPermission
...
//        initToolBar()
    ...
    fun initViews() {
        ...
        findViewById<View>(R.id.permisson_location).visibility = if (isLocationEnable() && RxPermissions(this).isGranted(Manifest.permission.ACCESS_COARSE_LOCATION)) {
            View.GONE
        } else {
            View.VISIBLE
        }
